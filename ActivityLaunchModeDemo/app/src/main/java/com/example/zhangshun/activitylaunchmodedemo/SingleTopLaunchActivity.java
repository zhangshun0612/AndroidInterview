...
public class SingleTopLaunchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.standardLaunchBtn:
                intent = new Intent(SingleTopLaunchActivity.this, StandardLaunchActivity.class);
                startActivity(intent);
                break;
            case R.id.singleTaskLaunchBtn:
                intent = new Intent(SingleTopLaunchActivity.this, SingleTaskLaunchActivity.class);
                startActivity(intent);
                break;
            case R.id.singleTopLaunchBtn:
                intent = new Intent(SingleTopLaunchActivity.this, SingleTopLaunchActivity.class);
                startActivity(intent);
                break;
            case R.id.singleInstanceLaunchBtn:
                intent = new Intent(SingleTopLaunchActivity.this, SingleInstanceLaunchActivity.class);
                startActivity(intent);
                break;
        }
    }
