...
public class StandardLaunchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.standardLaunchBtn:
                intent = new Intent(StandardLaunchActivity.this, StandardLaunchActivity.class);
                startActivity(intent);
                break;
            case R.id.singleTaskLaunchBtn:
                intent = new Intent(StandardLaunchActivity.this, SingleTaskLaunchActivity.class);
                startActivity(intent);
                break;
            case R.id.singleTopLaunchBtn:
                intent = new Intent(StandardLaunchActivity.this, SingleTopLaunchActivity.class);
                startActivity(intent);
                break;
            case R.id.singleInstanceLaunchBtn:
                intent = new Intent(StandardLaunchActivity.this, SingleInstanceLaunchActivity.class);
                startActivity(intent);
                break;
        }
